...
buttonmin.grid(row = 3, column = 4, padx=5, pady=5)
...
buttonplus.grid(row = 4, column = 4, padx=5, pady=5)
...
buttonper.grid(row = 1, column = 3, padx=5, pady=5)
...
buttonopen.grid(row = 5, column = 1, padx=5, pady=5)
...
buttonclose.grid(row = 5, column = 3, padx=5, pady=5)
...
buttondot.grid(row = 1, column = 2, padx=5, pady=5)
...
buttonequal.grid(row = 5, column = 4, padx=5, pady=5)
...
buttonclear.grid(row = 1, column = 1, padx=5, pady=5)
